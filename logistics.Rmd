...
A pesar de la diferencia, ¿será esta significativa?
...
Además, con la regresión logística podemos tener predictoes numéricos, lo que escapa de la utilidad de las tablas de contingencia:
...
Parece que el modelo 2  no es adecuado, revisemo usando el likelihood ratio test (que reemplaza al anova):
